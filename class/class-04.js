...
const user1 = new User("chorong", "Park");
console.log(user1);
...
const user2 = new NewUser("chorong", "Park");
console.log(user2.fullName); // Output: "chorong Park"

user2.lastName = "Kim"; // Modify lastName directly
console.log(user2.fullName); // Output: "chorong Kim"
